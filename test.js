...
test('should hash and verify a short password', async t => {
  m.hash('We are all unicorns', {digest: 'sha1', keylen: 64, iterations: 7500}).then(console.log);
  const password = 'p';
...
test('should hash and verify a long password', async t => {
  const password = '012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234';
